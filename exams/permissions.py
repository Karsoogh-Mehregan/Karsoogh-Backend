...
class CanViewSubmission(BasePermission):
    """Only the submission owner, assigned grader, or staff with view permission can view it."""
...
class CanGradeSubmission(BasePermission):
    ...
    def has_permission(self, request, view):
        return bool(request.user and request.user.is_authenticated and 
            request.user.is_staff and request.user.has_perm("exams.change_submission")
        )
